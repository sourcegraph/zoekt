...
func TestKotlin(t *testing.T) {
	exampleKotlin, err := os.ReadFile("./examples/example.kt")
	if err != nil {
		t.Fatal(err)
	}
...
func TestCpp(t *testing.T) {
	exampleCpp, err := os.ReadFile("./examples/example.cc")
	if err != nil {
		t.Fatal(err)
	}
...
func TestPython(t *testing.T) {
	examplePython, err := os.ReadFile("./examples/example.py")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRuby(t *testing.T) {
	exampleRuby, err := os.ReadFile("./examples/example.rb")
	if err != nil {
		t.Fatal(err)
	}
...
func TestScala(t *testing.T) {
	exampleScala, err := os.ReadFile("./examples/example.scala")
	if err != nil {
		t.Fatal(err)
	}
...
func checkScoring(t *testing.T, c scoreCase, useBM25 bool, parserType ctags.CTagsParserType) {
	...
	t.Run(name, func(t *testing.T) {
		...
		opts := index.Options{
			...
			LanguageMap: ctags.LanguageMap{c.language: parserType},
		}
...
func TestRepoRanks(t *testing.T) {
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			...
			err = b.Add(index.Document{Name: "example.java", Content: exampleJava})
			if err != nil {
				t.Fatal(err)
			}
