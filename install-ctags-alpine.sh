...
case "${TARGETARCH:-$(uname -m)}" in
  amd64 | x86_64)
    ...
    apk_sha256=bde53a3092fd540e004bf7923322a21604592734aea002086764f02456378c9d
    ;;
  arm64 | aarch64)
    apk_name="uctags-${CTAGS_VERSION}-linux-aarch64.release.apk"
    apk_sha256=245239f8097a2877ad91d14e742670d25ecd5bac7d2b77fdb0139dfcce291d22
    ;;
