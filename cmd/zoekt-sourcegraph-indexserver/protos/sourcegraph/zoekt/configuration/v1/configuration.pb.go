...
type DocumentRanksResponse struct {
	...
	//
	//	*DocumentRanksResponse_PathRanks_
	//	*DocumentRanksResponse_MeanRank_
	Payload isDocumentRanksResponse_Payload `protobuf_oneof:"payload"`
}
...
func (m *DocumentRanksResponse) GetPayload() isDocumentRanksResponse_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *DocumentRanksResponse) GetPathRanks() *DocumentRanksResponse_PathRanks {
	if x, ok := x.GetPayload().(*DocumentRanksResponse_PathRanks_); ok {
		return x.PathRanks
	}
	return nil
}

func (x *DocumentRanksResponse) GetMeanRank() *DocumentRanksResponse_MeanRank {
	if x, ok := x.GetPayload().(*DocumentRanksResponse_MeanRank_); ok {
		return x.MeanRank
	}
	return nil
}

type isDocumentRanksResponse_Payload interface {
	isDocumentRanksResponse_Payload()
}

type DocumentRanksResponse_PathRanks_ struct {
	PathRanks *DocumentRanksResponse_PathRanks `protobuf:"bytes,3,opt,name=path_ranks,json=pathRanks,proto3,oneof"`
}

type DocumentRanksResponse_MeanRank_ struct {
	MeanRank *DocumentRanksResponse_MeanRank `protobuf:"bytes,4,opt,name=mean_rank,json=meanRank,proto3,oneof"`
}

func (*DocumentRanksResponse_PathRanks_) isDocumentRanksResponse_Payload() {}

func (*DocumentRanksResponse_MeanRank_) isDocumentRanksResponse_Payload() {}
...
type DocumentRanksResponse_PathRanks struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// path_ranks is a list of path ranks.
	PathRanks []*DocumentRanksResponse_PathRank `protobuf:"bytes,1,rep,name=path_ranks,json=pathRanks,proto3" json:"path_ranks,omitempty"`
}

func (x *DocumentRanksResponse_PathRanks) Reset() {
	*x = DocumentRanksResponse_PathRanks{}
	if protoimpl.UnsafeEnabled {
...
func (x *DocumentRanksResponse_PathRanks) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DocumentRanksResponse_PathRanks) ProtoMessage() {}

func (x *DocumentRanksResponse_PathRanks) ProtoReflect() protoreflect.Message {
	mi := &file_configuration_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DocumentRanksResponse_PathRanks.ProtoReflect.Descriptor instead.
func (*DocumentRanksResponse_PathRanks) Descriptor() ([]byte, []int) {
	return file_configuration_proto_rawDescGZIP(), []int{9, 0}
}

func (x *DocumentRanksResponse_PathRanks) GetPathRanks() []*DocumentRanksResponse_PathRank {
	if x != nil {
		return x.PathRanks
	}
	return nil
...
type DocumentRanksResponse_PathRank struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	// Note: The file path is not guaranteed to UTF-8 encoded.
	Path []byte `protobuf:"bytes,1,opt,name=path,proto3" json:"path,omitempty"`
	// rank is the normalized number of references for a symbol defined in that path for a particular repository.
	// Normalized counts equal log_2({number of references to file} + 1), where references are considered
	// over all repositories.
	Rank float64 `protobuf:"fixed64,2,opt,name=rank,proto3" json:"rank,omitempty"`
}

func (x *DocumentRanksResponse_PathRank) Reset() {
	*x = DocumentRanksResponse_PathRank{}
	if protoimpl.UnsafeEnabled {
...
func (x *DocumentRanksResponse_PathRank) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DocumentRanksResponse_PathRank) ProtoMessage() {}

func (x *DocumentRanksResponse_PathRank) ProtoReflect() protoreflect.Message {
	mi := &file_configuration_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DocumentRanksResponse_PathRank.ProtoReflect.Descriptor instead.
func (*DocumentRanksResponse_PathRank) Descriptor() ([]byte, []int) {
	return file_configuration_proto_rawDescGZIP(), []int{9, 1}
}

func (x *DocumentRanksResponse_PathRank) GetPath() []byte {
	if x != nil {
		return x.Path
	}
	return nil
...
func (x *DocumentRanksResponse_PathRank) GetRank() float64 {
	if x != nil {
		return x.Rank
	}
	return 0
...
type DocumentRanksResponse_MeanRank struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// rank is the mean rank of all documents in the repository.
	Rank float64 `protobuf:"fixed64,1,opt,name=rank,proto3" json:"rank,omitempty"`
}

func (x *DocumentRanksResponse_MeanRank) Reset() {
	*x = DocumentRanksResponse_MeanRank{}
	if protoimpl.UnsafeEnabled {
...
func (x *DocumentRanksResponse_MeanRank) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DocumentRanksResponse_MeanRank) ProtoMessage() {}

func (x *DocumentRanksResponse_MeanRank) ProtoReflect() protoreflect.Message {
	mi := &file_configuration_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DocumentRanksResponse_MeanRank.ProtoReflect.Descriptor instead.
func (*DocumentRanksResponse_MeanRank) Descriptor() ([]byte, []int) {
	return file_configuration_proto_rawDescGZIP(), []int{9, 2}
}

func (x *DocumentRanksResponse_MeanRank) GetRank() float64 {
	if x != nil {
		return x.Rank
	}
	return 0
...
var file_configuration_proto_rawDesc = []byte{
	...
	0x67, 0x73, 0x22, 0xda, 0x03, 0x0a, 0x11, 0x5a, 0x6f, 0x65, 0x6b, 0x74, 0x49, 0x6e, 0x64, 0x65,
	...
	0x6e, 0x67, 0x52, 0x0b, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x4d, 0x61, 0x70, 0x22,
	0x45, 0x0a, 0x15, 0x5a, 0x6f, 0x65, 0x6b, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f,
	0x72, 0x79, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07,
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76,
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x4a, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	...
	0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x64, 0x5f, 0x69, 0x64, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52, 0x0a, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x64, 0x49,
	0x64, 0x73, 0x22, 0x29, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x72, 0x65, 0x70, 0x6f, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x05, 0x52, 0x07, 0x72, 0x65, 0x70, 0x6f, 0x49, 0x64, 0x73, 0x22, 0x36, 0x0a,
	0x14, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x61, 0x6e, 0x6b, 0x73, 0x52, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x6a, 0x5a, 0x68, 0x67,
	...
	0x68, 0x2d, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x67, 0x72, 0x61, 0x70, 0x68,
	0x2f, 0x7a, 0x6f, 0x65, 0x6b, 0x74, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61,
...
var file_configuration_proto_goTypes = []interface{}{
	...
	(*DocumentRanksResponse_PathRanks)(nil),     // 13: sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.PathRanks
	(*DocumentRanksResponse_PathRank)(nil),      // 14: sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.PathRank
	(*DocumentRanksResponse_MeanRank)(nil),      // 15: sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.MeanRank
	(*UpdateIndexStatusRequest_Repository)(nil), // 16: sourcegraph.zoekt.configuration.v1.UpdateIndexStatusRequest.Repository
...
var file_configuration_proto_depIdxs = []int32{
	...
	17, // 3: sourcegraph.zoekt.configuration.v1.Fingerprint.generated_at:type_name -> google.protobuf.Timestamp
	...
	13, // 7: sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.path_ranks:type_name -> sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.PathRanks
	15, // 8: sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.mean_rank:type_name -> sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.MeanRank
	16, // 9: sourcegraph.zoekt.configuration.v1.UpdateIndexStatusRequest.repositories:type_name -> sourcegraph.zoekt.configuration.v1.UpdateIndexStatusRequest.Repository
	14, // 10: sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.PathRanks.path_ranks:type_name -> sourcegraph.zoekt.configuration.v1.DocumentRanksResponse.PathRank
	6,  // 11: sourcegraph.zoekt.configuration.v1.UpdateIndexStatusRequest.Repository.branches:type_name -> sourcegraph.zoekt.configuration.v1.ZoektRepositoryBranch
	1,  // 12: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.SearchConfiguration:input_type -> sourcegraph.zoekt.configuration.v1.SearchConfigurationRequest
	7,  // 13: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.List:input_type -> sourcegraph.zoekt.configuration.v1.ListRequest
	9,  // 14: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.DocumentRanks:input_type -> sourcegraph.zoekt.configuration.v1.DocumentRanksRequest
	11, // 15: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.UpdateIndexStatus:input_type -> sourcegraph.zoekt.configuration.v1.UpdateIndexStatusRequest
	2,  // 16: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.SearchConfiguration:output_type -> sourcegraph.zoekt.configuration.v1.SearchConfigurationResponse
	8,  // 17: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.List:output_type -> sourcegraph.zoekt.configuration.v1.ListResponse
	10, // 18: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.DocumentRanks:output_type -> sourcegraph.zoekt.configuration.v1.DocumentRanksResponse
	12, // 19: sourcegraph.zoekt.configuration.v1.ZoektConfigurationService.UpdateIndexStatus:output_type -> sourcegraph.zoekt.configuration.v1.UpdateIndexStatusResponse
...
func file_configuration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_configuration_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DocumentRanksResponse_PathRanks); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_configuration_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DocumentRanksResponse_PathRank); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_configuration_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DocumentRanksResponse_MeanRank); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_configuration_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*DocumentRanksResponse_PathRanks_)(nil),
		(*DocumentRanksResponse_MeanRank_)(nil),
	}
	type x struct{}
