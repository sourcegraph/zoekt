...
func TestOverlaps(t *testing.T) {
	tests := []struct {
		...
		//
		{
			documentSections: []DocumentSection{{0, 3}, {5, 10}},
			start:            6,
			end:              9,
			pos:              -1,
		},
		...
		{
			documentSections: []DocumentSection{{0, 3}},
			start:            0,
			end:              1,
			pos:              -1,
		},
		...
		//
		{
			documentSections: []DocumentSection{{2, 3}, {5, 10}},
			start:            0,
			end:              2,
			pos:              0,
		},
		...
		{
			documentSections: []DocumentSection{{0, 3}, {5, 10}, {14, 15}},
			start:            11,
			end:              13,
			pos:              2,
		},
