...
func searcherForTest(t *testing.T, b *zoekt.IndexBuilder) stream.NewSearcher {
...
func (a adapter) StreamSearch(ctx context.Context, q query.Q, opts *zoekt.SearchOptions, sender stream.Streamer) (err error) {
