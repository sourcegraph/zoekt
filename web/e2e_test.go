				...
				Matches: []Match{
					{
						...
						Before: []ContextLine{
							{LineNum: 2, Line: "second snippet"},
							{LineNum: 3, Line: "third thing"},
						},
						After: []ContextLine{
							{LineNum: 5, Line: "fifth block"},
							{LineNum: 6, Line: "sixth example"},
						},
					},
				},
			},
				...
				Matches: []Match{
					{
						...
						Before: []ContextLine{
							{LineNum: 1, Line: "one line"},
							{LineNum: 2, Line: "second snippet"},
							{LineNum: 3, Line: "third thing"},
							{LineNum: 4, Line: "fourth"},
							{LineNum: 5, Line: "fifth block"},
							{LineNum: 6, Line: "sixth example"},
						},
					},
