...
type SearchOptions_SchedulingClass int32

const (
	// Default class for latency-sensitive searches. Interactive requests that
	// run for long enough are demoted to the batch queue as a safety backstop.
	SearchOptions_SCHEDULING_CLASS_INTERACTIVE_UNSPECIFIED SearchOptions_SchedulingClass = 0
	// Class for bulk searches that should be admitted directly to the batch
	// queue without consuming interactive capacity.
	SearchOptions_SCHEDULING_CLASS_BATCH SearchOptions_SchedulingClass = 1
)

// Enum value maps for SearchOptions_SchedulingClass.
var (
	SearchOptions_SchedulingClass_name = map[int32]string{
		0: "SCHEDULING_CLASS_INTERACTIVE_UNSPECIFIED",
		1: "SCHEDULING_CLASS_BATCH",
	}
	SearchOptions_SchedulingClass_value = map[string]int32{
		"SCHEDULING_CLASS_INTERACTIVE_UNSPECIFIED": 0,
		"SCHEDULING_CLASS_BATCH":                   1,
	}
)

func (x SearchOptions_SchedulingClass) Enum() *SearchOptions_SchedulingClass {
	p := new(SearchOptions_SchedulingClass)
	*p = x
	return p
}

func (x SearchOptions_SchedulingClass) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SearchOptions_SchedulingClass) Descriptor() protoreflect.EnumDescriptor {
	return file_zoekt_webserver_v1_webserver_proto_enumTypes[1].Descriptor()
}

func (SearchOptions_SchedulingClass) Type() protoreflect.EnumType {
	return &file_zoekt_webserver_v1_webserver_proto_enumTypes[1]
}

func (x SearchOptions_SchedulingClass) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SearchOptions_SchedulingClass.Descriptor instead.
func (SearchOptions_SchedulingClass) EnumDescriptor() ([]byte, []int) {
	return file_zoekt_webserver_v1_webserver_proto_rawDescGZIP(), []int{4, 0}
}
...
func (ListOptions_RepoListField) Descriptor() protoreflect.EnumDescriptor {
	return file_zoekt_webserver_v1_webserver_proto_enumTypes[2].Descriptor()
}

func (ListOptions_RepoListField) Type() protoreflect.EnumType {
	return &file_zoekt_webserver_v1_webserver_proto_enumTypes[2]
}
...
type SearchOptions struct {
	...
	// Scheduler queue used to admit this request.
	SchedulingClass SearchOptions_SchedulingClass `protobuf:"varint,17,opt,name=scheduling_class,json=schedulingClass,proto3,enum=zoekt.webserver.v1.SearchOptions_SchedulingClass" json:"scheduling_class,omitempty"`
...
func (x *SearchOptions) GetSchedulingClass() SearchOptions_SchedulingClass {
	if x != nil {
		return x.SchedulingClass
	}
	return SearchOptions_SCHEDULING_CLASS_INTERACTIVE_UNSPECIFIED
}
...
func (x *Repository) GetTenantId() int64 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
func (x *Repository) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type Stats struct {
	...
	// Portion of files_skipped caused by a context cancellation observed while
	// searching a shard. This includes cancellations caused by deadlines and
	// internal search limits.
	FilesSkippedDueToCancellation int64 `protobuf:"varint,21,opt,name=files_skipped_due_to_cancellation,json=filesSkippedDueToCancellation,proto3" json:"files_skipped_due_to_cancellation,omitempty"`
}
...
func (x *Stats) GetFilesSkippedDueToCancellation() int64 {
	if x != nil {
		return x.FilesSkippedDueToCancellation
	}
	return 0
}
...
type ChunkMatch struct {
	...
	BestLineMatch uint32        `protobuf:"varint,8,opt,name=best_line_match,json=bestLineMatch,proto3" json:"best_line_match,omitempty"`
}
...
func (x *ChunkMatch) GetBestLineMatch() uint32 {
	if x != nil {
		return x.BestLineMatch
	}
	return 0
}
...
var file_zoekt_webserver_v1_webserver_proto_rawDesc = []byte{
	...
	0x43, 0x68, 0x75, 0x6e, 0x6b, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x06, 0x22, 0xda, 0x06, 0x0a, 0x0d,
	...
	,
	...
	,
	...
	,
	...
	0x06, 0x22, 0xce, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x70, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x3e, 0x0a, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x7a, 0x6f, 0x65, 0x6b, 0x74, 0x2e,
	...
	0x6f, 0x72, 0x79, 0x12, 0x48, 0x0a, 0x0e, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x6d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x7a, 0x6f,
	0x65, 0x6b, 0x74, 0x2e, 0x77, 0x65, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31,
	0x2e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x0d,
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x33, 0x0a,
	0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x7a,
	...
	0x74, 0x73, 0x22, 0x96, 0x08, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	...
	0x40, 0x0a, 0x08, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x24, 0x2e, 0x7a, 0x6f, 0x65, 0x6b, 0x74, 0x2e, 0x77, 0x65, 0x62, 0x73, 0x65, 0x72,
	...
	0x73, 0x12, 0x50, 0x0a, 0x0c, 0x73, 0x75, 0x62, 0x5f, 0x72, 0x65, 0x70, 0x6f, 0x5f, 0x6d, 0x61,
	0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x7a, 0x6f, 0x65, 0x6b, 0x74, 0x2e,
	0x77, 0x65, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x70,
	...
	0x79, 0x12, 0x4c, 0x0a, 0x0a, 0x72, 0x61, 0x77, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18,
	0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x7a, 0x6f, 0x65, 0x6b, 0x74, 0x2e, 0x77, 0x65,
	0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x73,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd6, 0x03, 0x0a, 0x0d,
	...
	,
	...
	0x12, 0x26, 0x0a, 0x0f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x75,
	0x6e, 0x69, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x69, 0x6e, 0x64, 0x65, 0x78,
	0x54, 0x69, 0x6d, 0x65, 0x55, 0x6e, 0x69, 0x78, 0x22, 0x40, 0x0a, 0x10, 0x52, 0x65, 0x70, 0x6f,
	...
	0x4c, 0x69, 0x6e, 0x65, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xf3, 0x07, 0x0a, 0x05, 0x53,
	...
	,
	...
	,
	...
	0x6e, 0x74, 0x73, 0x22, 0xc5, 0x01, 0x0a, 0x11, 0x4c, 0x69, 0x6e, 0x65, 0x46, 0x72, 0x61, 0x67,
	...
	0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x44, 0x0a, 0x0b, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x5f,
	0x69, 0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x7a, 0x6f, 0x65,
	...
	0x72, 0x65, 0x6e, 0x74, 0x4b, 0x69, 0x6e, 0x64, 0x22, 0xd9, 0x02, 0x0a, 0x0a, 0x43, 0x68, 0x75,
	...
	0x74, 0x12, 0x41, 0x0a, 0x0d, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x7a, 0x6f, 0x65, 0x6b, 0x74,
	...
	0x65, 0x12, 0x31, 0x0a, 0x06, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x19, 0x2e, 0x7a, 0x6f, 0x65, 0x6b, 0x74, 0x2e, 0x77, 0x65, 0x62, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x06, 0x72, 0x61,
	0x6e, 0x67, 0x65, 0x73, 0x12, 0x3f, 0x0a, 0x0b, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x7a, 0x6f, 0x65, 0x6b,
	0x74, 0x2e, 0x77, 0x65, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53,
	...
	,
	...
	0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x2a, 0x8c, 0x01, 0x0a, 0x0b, 0x46, 0x6c, 0x75, 0x73,
	0x68, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x24, 0x0a, 0x20, 0x46, 0x4c, 0x55, 0x53, 0x48,
	...
	,
	...
	0x6b, 0x74, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x7a,
	0x6f, 0x65, 0x6b, 0x74, 0x2f, 0x77, 0x65, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x76,
...
var file_zoekt_webserver_v1_webserver_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_zoekt_webserver_v1_webserver_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_zoekt_webserver_v1_webserver_proto_goTypes = []interface{}{
	(FlushReason)(0),                   // 0: zoekt.webserver.v1.FlushReason
	(SearchOptions_SchedulingClass)(0), // 1: zoekt.webserver.v1.SearchOptions.SchedulingClass
	(ListOptions_RepoListField)(0),     // 2: zoekt.webserver.v1.ListOptions.RepoListField
	(*SearchRequest)(nil),              // 3: zoekt.webserver.v1.SearchRequest
	(*SearchResponse)(nil),             // 4: zoekt.webserver.v1.SearchResponse
	(*StreamSearchRequest)(nil),        // 5: zoekt.webserver.v1.StreamSearchRequest
	(*StreamSearchResponse)(nil),       // 6: zoekt.webserver.v1.StreamSearchResponse
	(*SearchOptions)(nil),              // 7: zoekt.webserver.v1.SearchOptions
	(*ListRequest)(nil),                // 8: zoekt.webserver.v1.ListRequest
	(*ListOptions)(nil),                // 9: zoekt.webserver.v1.ListOptions
	(*ListResponse)(nil),               // 10: zoekt.webserver.v1.ListResponse
	(*RepoListEntry)(nil),              // 11: zoekt.webserver.v1.RepoListEntry
	(*Repository)(nil),                 // 12: zoekt.webserver.v1.Repository
	(*IndexMetadata)(nil),              // 13: zoekt.webserver.v1.IndexMetadata
	(*MinimalRepoListEntry)(nil),       // 14: zoekt.webserver.v1.MinimalRepoListEntry
	(*RepositoryBranch)(nil),           // 15: zoekt.webserver.v1.RepositoryBranch
	(*RepoStats)(nil),                  // 16: zoekt.webserver.v1.RepoStats
	(*Stats)(nil),                      // 17: zoekt.webserver.v1.Stats
	(*Progress)(nil),                   // 18: zoekt.webserver.v1.Progress
	(*FileMatch)(nil),                  // 19: zoekt.webserver.v1.FileMatch
	(*LineMatch)(nil),                  // 20: zoekt.webserver.v1.LineMatch
	(*LineFragmentMatch)(nil),          // 21: zoekt.webserver.v1.LineFragmentMatch
	(*SymbolInfo)(nil),                 // 22: zoekt.webserver.v1.SymbolInfo
	(*ChunkMatch)(nil),                 // 23: zoekt.webserver.v1.ChunkMatch
	(*Range)(nil),                      // 24: zoekt.webserver.v1.Range
	(*Location)(nil),                   // 25: zoekt.webserver.v1.Location
	nil,                                // 26: zoekt.webserver.v1.ListResponse.ReposMapEntry
	nil,                                // 27: zoekt.webserver.v1.Repository.SubRepoMapEntry
	nil,                                // 28: zoekt.webserver.v1.Repository.RawConfigEntry
	nil,                                // 29: zoekt.webserver.v1.Repository.MetadataEntry
	nil,                                // 30: zoekt.webserver.v1.IndexMetadata.LanguageMapEntry
	(*Q)(nil),                          // 31: zoekt.webserver.v1.Q
	(*durationpb.Duration)(nil),        // 32: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),      // 33: google.protobuf.Timestamp
}
var file_zoekt_webserver_v1_webserver_proto_depIdxs = []int32{
	31, // 0: zoekt.webserver.v1.SearchRequest.query:type_name -> zoekt.webserver.v1.Q
	7,  // 1: zoekt.webserver.v1.SearchRequest.opts:type_name -> zoekt.webserver.v1.SearchOptions
	17, // 2: zoekt.webserver.v1.SearchResponse.stats:type_name -> zoekt.webserver.v1.Stats
	18, // 3: zoekt.webserver.v1.SearchResponse.progress:type_name -> zoekt.webserver.v1.Progress
	19, // 4: zoekt.webserver.v1.SearchResponse.files:type_name -> zoekt.webserver.v1.FileMatch
	3,  // 5: zoekt.webserver.v1.StreamSearchRequest.request:type_name -> zoekt.webserver.v1.SearchRequest
	4,  // 6: zoekt.webserver.v1.StreamSearchResponse.response_chunk:type_name -> zoekt.webserver.v1.SearchResponse
	32, // 7: zoekt.webserver.v1.SearchOptions.max_wall_time:type_name -> google.protobuf.Duration
	32, // 8: zoekt.webserver.v1.SearchOptions.flush_wall_time:type_name -> google.protobuf.Duration
	1,  // 9: zoekt.webserver.v1.SearchOptions.scheduling_class:type_name -> zoekt.webserver.v1.SearchOptions.SchedulingClass
	31, // 10: zoekt.webserver.v1.ListRequest.query:type_name -> zoekt.webserver.v1.Q
	9,  // 11: zoekt.webserver.v1.ListRequest.opts:type_name -> zoekt.webserver.v1.ListOptions
	2,  // 12: zoekt.webserver.v1.ListOptions.field:type_name -> zoekt.webserver.v1.ListOptions.RepoListField
	11, // 13: zoekt.webserver.v1.ListResponse.repos:type_name -> zoekt.webserver.v1.RepoListEntry
	26, // 14: zoekt.webserver.v1.ListResponse.repos_map:type_name -> zoekt.webserver.v1.ListResponse.ReposMapEntry
	16, // 15: zoekt.webserver.v1.ListResponse.stats:type_name -> zoekt.webserver.v1.RepoStats
	12, // 16: zoekt.webserver.v1.RepoListEntry.repository:type_name -> zoekt.webserver.v1.Repository
	13, // 17: zoekt.webserver.v1.RepoListEntry.index_metadata:type_name -> zoekt.webserver.v1.IndexMetadata
	16, // 18: zoekt.webserver.v1.RepoListEntry.stats:type_name -> zoekt.webserver.v1.RepoStats
	15, // 19: zoekt.webserver.v1.Repository.branches:type_name -> zoekt.webserver.v1.RepositoryBranch
	27, // 20: zoekt.webserver.v1.Repository.sub_repo_map:type_name -> zoekt.webserver.v1.Repository.SubRepoMapEntry
	28, // 21: zoekt.webserver.v1.Repository.raw_config:type_name -> zoekt.webserver.v1.Repository.RawConfigEntry
	33, // 22: zoekt.webserver.v1.Repository.latest_commit_date:type_name -> google.protobuf.Timestamp
	29, // 23: zoekt.webserver.v1.Repository.metadata:type_name -> zoekt.webserver.v1.Repository.MetadataEntry
	33, // 24: zoekt.webserver.v1.IndexMetadata.index_time:type_name -> google.protobuf.Timestamp
	30, // 25: zoekt.webserver.v1.IndexMetadata.language_map:type_name -> zoekt.webserver.v1.IndexMetadata.LanguageMapEntry
	15, // 26: zoekt.webserver.v1.MinimalRepoListEntry.branches:type_name -> zoekt.webserver.v1.RepositoryBranch
	32, // 27: zoekt.webserver.v1.Stats.duration:type_name -> google.protobuf.Duration
	32, // 28: zoekt.webserver.v1.Stats.wait:type_name -> google.protobuf.Duration
	32, // 29: zoekt.webserver.v1.Stats.match_tree_construction:type_name -> google.protobuf.Duration
	32, // 30: zoekt.webserver.v1.Stats.match_tree_search:type_name -> google.protobuf.Duration
	0,  // 31: zoekt.webserver.v1.Stats.flush_reason:type_name -> zoekt.webserver.v1.FlushReason
	20, // 32: zoekt.webserver.v1.FileMatch.line_matches:type_name -> zoekt.webserver.v1.LineMatch
	23, // 33: zoekt.webserver.v1.FileMatch.chunk_matches:type_name -> zoekt.webserver.v1.ChunkMatch
	21, // 34: zoekt.webserver.v1.LineMatch.line_fragments:type_name -> zoekt.webserver.v1.LineFragmentMatch
	22, // 35: zoekt.webserver.v1.LineFragmentMatch.symbol_info:type_name -> zoekt.webserver.v1.SymbolInfo
	25, // 36: zoekt.webserver.v1.ChunkMatch.content_start:type_name -> zoekt.webserver.v1.Location
	24, // 37: zoekt.webserver.v1.ChunkMatch.ranges:type_name -> zoekt.webserver.v1.Range
	22, // 38: zoekt.webserver.v1.ChunkMatch.symbol_info:type_name -> zoekt.webserver.v1.SymbolInfo
	25, // 39: zoekt.webserver.v1.Range.start:type_name -> zoekt.webserver.v1.Location
	25, // 40: zoekt.webserver.v1.Range.end:type_name -> zoekt.webserver.v1.Location
	14, // 41: zoekt.webserver.v1.ListResponse.ReposMapEntry.value:type_name -> zoekt.webserver.v1.MinimalRepoListEntry
	12, // 42: zoekt.webserver.v1.Repository.SubRepoMapEntry.value:type_name -> zoekt.webserver.v1.Repository
	3,  // 43: zoekt.webserver.v1.WebserverService.Search:input_type -> zoekt.webserver.v1.SearchRequest
	5,  // 44: zoekt.webserver.v1.WebserverService.StreamSearch:input_type -> zoekt.webserver.v1.StreamSearchRequest
	8,  // 45: zoekt.webserver.v1.WebserverService.List:input_type -> zoekt.webserver.v1.ListRequest
	4,  // 46: zoekt.webserver.v1.WebserverService.Search:output_type -> zoekt.webserver.v1.SearchResponse
	6,  // 47: zoekt.webserver.v1.WebserverService.StreamSearch:output_type -> zoekt.webserver.v1.StreamSearchResponse
	10, // 48: zoekt.webserver.v1.WebserverService.List:output_type -> zoekt.webserver.v1.ListResponse
