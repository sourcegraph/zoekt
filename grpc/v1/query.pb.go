...
var file_query_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x22, 0x2d, 0x0a, 0x03, 0x41, 0x6e, 0x64, 0x12, 0x26, 0x0a, 0x08, 0x63, 0x68,
	...
	0x65, 0x6e, 0x22, 0x2c, 0x0a, 0x02, 0x4f, 0x72, 0x12, 0x26, 0x0a, 0x08, 0x63, 0x68, 0x69, 0x6c,
	0x64, 0x72, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x67, 0x72, 0x70,
	0x63, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x52, 0x08, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e,
	0x22, 0x27, 0x0a, 0x03, 0x4e, 0x6f, 0x74, 0x12, 0x20, 0x0a, 0x05, 0x63, 0x68, 0x69, 0x6c, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x76, 0x31,
	0x2e, 0x51, 0x52, 0x05, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x22, 0x38, 0x0a, 0x06, 0x42, 0x72, 0x61,
	...
	0x61, 0x63, 0x74, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_query_proto_goTypes = []interface{}{
	...
	(*Q)(nil),             // 1: grpc.v1.Q
	(*RawConfig)(nil),     // 2: grpc.v1.RawConfig
	(*Regexp)(nil),        // 3: grpc.v1.Regexp
	(*Symbol)(nil),        // 4: grpc.v1.Symbol
	(*Language)(nil),      // 5: grpc.v1.Language
	(*Repo)(nil),          // 6: grpc.v1.Repo
	(*RepoRegexp)(nil),    // 7: grpc.v1.RepoRegexp
	(*BranchesRepos)(nil), // 8: grpc.v1.BranchesRepos
	(*BranchRepos)(nil),   // 9: grpc.v1.BranchRepos
	(*RepoIds)(nil),       // 10: grpc.v1.RepoIds
	(*RepoSet)(nil),       // 11: grpc.v1.RepoSet
	(*FileNameSet)(nil),   // 12: grpc.v1.FileNameSet
	(*Type)(nil),          // 13: grpc.v1.Type
	(*Substring)(nil),     // 14: grpc.v1.Substring
	(*And)(nil),           // 15: grpc.v1.And
	(*Or)(nil),            // 16: grpc.v1.Or
	(*Not)(nil),           // 17: grpc.v1.Not
	(*Branch)(nil),        // 18: grpc.v1.Branch
	nil,                   // 19: grpc.v1.RepoSet.SetEntry
}
var file_query_proto_depIdxs = []int32{
	2,  // 0: grpc.v1.Q.raw_config:type_name -> grpc.v1.RawConfig
	3,  // 1: grpc.v1.Q.regexp:type_name -> grpc.v1.Regexp
	4,  // 2: grpc.v1.Q.symbol:type_name -> grpc.v1.Symbol
	5,  // 3: grpc.v1.Q.language:type_name -> grpc.v1.Language
	6,  // 4: grpc.v1.Q.repo:type_name -> grpc.v1.Repo
	7,  // 5: grpc.v1.Q.repo_regexp:type_name -> grpc.v1.RepoRegexp
	8,  // 6: grpc.v1.Q.branches_repos:type_name -> grpc.v1.BranchesRepos
	10, // 7: grpc.v1.Q.repo_ids:type_name -> grpc.v1.RepoIds
	11, // 8: grpc.v1.Q.repo_set:type_name -> grpc.v1.RepoSet
	12, // 9: grpc.v1.Q.file_name_set:type_name -> grpc.v1.FileNameSet
	13, // 10: grpc.v1.Q.type:type_name -> grpc.v1.Type
	14, // 11: grpc.v1.Q.substring:type_name -> grpc.v1.Substring
	15, // 12: grpc.v1.Q.and:type_name -> grpc.v1.And
	16, // 13: grpc.v1.Q.or:type_name -> grpc.v1.Or
	17, // 14: grpc.v1.Q.not:type_name -> grpc.v1.Not
	18, // 15: grpc.v1.Q.branch:type_name -> grpc.v1.Branch
	0,  // 16: grpc.v1.RawConfig.flags:type_name -> grpc.v1.RawConfig.Flag
	1,  // 17: grpc.v1.Symbol.expr:type_name -> grpc.v1.Q
	9,  // 18: grpc.v1.BranchesRepos.list:type_name -> grpc.v1.BranchRepos
	19, // 19: grpc.v1.RepoSet.set:type_name -> grpc.v1.RepoSet.SetEntry
	1,  // 20: grpc.v1.Type.child:type_name -> grpc.v1.Q
	1,  // 21: grpc.v1.And.children:type_name -> grpc.v1.Q
	1,  // 22: grpc.v1.Or.children:type_name -> grpc.v1.Q
	1,  // 23: grpc.v1.Not.child:type_name -> grpc.v1.Q
